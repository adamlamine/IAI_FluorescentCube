...
boolean Adafruit_MPR121::begin(uint8_t i2caddr, TwoWire *theWire,
  ...
  writeRegister(MPR121_CONFIG1, 0b11111111); // 6 Samples, 32uA charge current 
  writeRegister(MPR121_CONFIG2, 0b10000010); // 1uS encoding, 18 samples 2nd level filter, 1ms period between samples
...
void Adafruit_MPR121::off(){
  writeRegister(MPR121_ECR, 0x00);
}

void Adafruit_MPR121::on(){
  writeRegister(MPR121_ECR, 0x8F);
}
